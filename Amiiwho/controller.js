...
// Prüfen, ob das Objekt window definiert ist (nur im Browser verfügbar)
...
if (typeof window !== 'undefined') {
    window.addEventListener("load", () =>{
        const elements = document.getElementsByClassName("homepage-text");
...
if (typeof window !== 'undefined') {
    // Fügen Sie den Event-Listener nur hinzu, wenn sich der Code im Browserkontext befindet
    window.addEventListener('DOMContentLoaded', () => {
        // Event-Listener für das Klicken auf das Lesezeichen hinzufügen
